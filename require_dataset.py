...
<<<<<<< HEAD:face-antispoof-model/data/require_dataset.py
train_filelists=[
...
>>>>>>> 5dc91c2fbb1c99151ea35b72d17e4bc12b73fe23:data/require_dataset.py
...
class myData(torch.utils.data.Dataset):
    ...
    def crop_with_ldmk(self, image, landmark):
        ...
        dst = np.float32(
            [((self.image_size - 1) / 2.0, (self.image_size - 1) / 2.0), ((self.image_size - 1), (self.image_size - 1)),
    ...
    def __getitem__(self, index):  # [img,label]
        if not self.test:
...
if __name__ == '__main__':
    ...
    train_data = myData(filelists=train_filelists, transform=None, test=False, data_source='none')
    val_data = myData(filelists=test_filelists, transform=None, test=False, data_source='none')
